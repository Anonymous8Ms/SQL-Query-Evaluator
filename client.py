...
"""Sql Query Env Environment Client."""
...
class SqlQueryEnv(
    ...
    """
    Client for the Sql Query Env Environment.
    ...
    Example:
        ...
        >>> with SqlQueryEnv(base_url="http://localhost:8000") as client:
        ...     result = client.reset()
        ...     print(result.observation.echoed_message)
        ...
        ...     result = client.step(SqlQueryAction(message="Hello!"))
        ...     print(result.observation.echoed_message)

    Example with Docker:
        >>> # Automatically start container and connect
        >>> client = SqlQueryEnv.from_docker_image("sql_query_env-env:latest")
        >>> try:
        ...     result = client.reset()
        ...     result = client.step(SqlQueryAction(message="Test"))
        ... finally:
        ...     client.close()
    """
    ...
    def _step_payload(self, action: SqlQueryAction) -> Dict:
        ...
        Args:
            action: SqlQueryAction instance
    ...
    def _parse_result(self, payload: Dict) -> StepResult[SqlQueryObservation]:
        ...
        Returns:
            StepResult with SqlQueryObservation
        """
