SQL_TASKS = [
    {
        ...
        "difficulty": "easy",
        "db_schema": "customers(id, name, city, email)",
    ...
    },
    {
        ...
        "difficulty": "easy",
        "db_schema": "orders(id, customer_id, total, date)",
        "correct_output": [(4,)],
    ...
    },
    {
        ...
        "difficulty": "medium",
        "db_schema": "customers(id, name), orders(customer_id, date)",
    ...
    },
    {
        ...
        "difficulty": "medium",
        "db_schema": "products(name), order_items(product_id), orders(id, customer_id)",
