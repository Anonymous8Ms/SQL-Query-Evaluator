...
"""
FastAPI application for the Sql Query Env Environment.

This module creates an HTTP server that exposes the SqlQueryEnvironment
...
def main(host: str = "0.0.0.0", port: int = 8000):
    ...
    multiple workers:
        uvicorn sql_query_env.server.app:app --workers 4
    """
    import uvicorn
